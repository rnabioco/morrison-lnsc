...
params:
  ...
  unenr_8:      "results/2021-04-16"
  enr_8:        "results/2021-07-16"
...
#   map_dfr(~ {
#     x <- x %>%
#       mutate(lec_type = ifelse(lec_type == .x, lec_type, "other")) %>%
#       split(.$lec_type)
# 
#     x <- x[c(.x, "other")]
#     
...
# 
#     p %>%
#       mutate(type = .x, n = length(typ_dat), mean = mean(typ_dat), sd = sd(typ_dat))
#   }) %>%
#   arrange(p.value) %>%
