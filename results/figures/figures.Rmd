...
Mxra8 expression is shown for CHIKV+/- cells for the 8 hpi timepoint. Mxra8 expression appears to be higher in CHIKV+ FRCs and BECs, suggesting a distinct mechanism of CHIKV entry. This is a result we have discussed previously, and might be good to include in a supplemental figure.

```{r, fig.width = 6, fig.height = 5}

lec_type_cols[c("FRC", "BEC")] %>%
  imap(~ {
    plt_dat %>%
      create_gene_boxplot(
        GENE = "Mxra8", TYPE = .y,
...
```{r "fig S3 cell type", fig.width = 12, fig.height = 18}
plot_grid(
...
```{r "fig S3 cell type", fig.width = 12, fig.height = 20}
plot_grid(
