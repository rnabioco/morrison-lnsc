...
B.  UMAP projection shows CHIKV sgRNA ratio (sgRNA counts / 5' counts) for the 24 hpi timepoint. A pseudo count of 1 was added to the sgRNA and 5' counts to eliminate division by zero.
...
E.  Enrichment scores are shown for the top GO modules identified for the 24 hpi timepoint, as described in C.
