...
```{r "create 8hpi object 1", include = FALSE, eval = create_so}
...
```{r "create 8hpi object 2", eval = create_so}
...
clmns <- c("cell_type", "lec_type", "lec_subtype", "frc_type", "frc_subtype", "chikv_type")
